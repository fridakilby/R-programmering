...
# Summera ihop bilar per år och region för enklare hantering
...
# Dela in classer i dummies för drivmedel
...
# Train, val, test - dela in modellen för att träna oilika modeller
...
# Sätt år med noll bilar till NaN för att kunna träna modell med logaritmerad y-variabel
...
# träna om modell ed6 och prediktera värden för 2024
